...
<head>
    ...
    <title>Tome 9</title> <!--Changer Titre de la page-->
...
<body>
    ...
    <div class="contenu-scrollable">
        <div class="image-fixe">
            <img class="couverture_livre" src="../Addons/Images_de_couverture/287695219X.jpg" alt="287695219X"> <!--Changer l'image de couverture-->
            <button id="plein-ecran">Plein écran</button>
        </div>

        <div class="texte-défilant">
            <h1>Dragon Ball, Tome 9 : Sangohan</h1> <!--Changer Tire du livre-->
            <p>L'histoire se concentre sur le jeune Sangohan, le fils de Sangoku, et ses aventures, ainsi que sur l'évolution de ses pouvoirs</p> <!--Changer le résumé-->
        </div>
    </div>
